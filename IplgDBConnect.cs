...
namespace plgDBConnect
{
    ...
    public enum DBServerStateType
    {
        ...
        Standart,
        /// <summary>
        /// Встраиваемый сервер (только для FireBird)
        /// </summary>
        Embedded
    };
    /// <summary>
    ...
    public abstract class IplgDBConnect : IDisposable
    {
        ...
        /// <param name="tr">Транзакция, в рамках которой выполняется запрос</param>
        /// <returns>Количество обработанных записей или -1 при ошибке</returns>
        public abstract int ExecuteNonQuery(IDbCommand Cmd, IDbTransaction tr);
        ...
        /// <param name="tr">Транзакция, в рамках которой выполняется запрос</param>
        /// <returns>Количество обработанных записей или -1 при ошибке</returns>
        public abstract int ExecuteNonQuery(string SQL, IDbTransaction tr);
        ...
        public abstract object ExecuteScalar(string SQL, IDbTransaction tr);
        ...
        /// <param name="tr">Транзакция, в рамках которой выполняется запрос</param>
        /// <returns>Полученное значение</returns>
        public abstract object ExecuteScalar(IDbCommand Cmd, IDbTransaction tr);
        ...
        public abstract long FillDataTable(DataTable tbl, IDbCommand Cmd, IDbTransaction tr);
        ...
        public abstract long FillDataTable(DataTable tbl, string Cmd, IDbTransaction tr);
        ...
        /// </summary>
        /// <param name="Cmd">Сформированная команда</param>
        /// <param name="tr">Ссылка на активную транзакцию</param>
        /// <returns>Интерфейс IDataReader</returns>
        public abstract IDataReader ExecuteReader(IDbCommand Cmd, IDbTransaction tr);
        /// <summary>
        ...
        /// <param name="tr">Ссылка на активную транзакцию</param>
        /// <returns></returns>
        public abstract Task<DbDataReader> ExecuteReaderAsync(IDbCommand Cmd, IDbTransaction tr);
        /// <summary>
